...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="http://<?=$host_name["ip_address"]?>/coinpay-admin/assets/css/overview/overview.css">
        ...
        <script src="http://<?=$host_name["ip_address"]?>/coinpay-admin/assets/js/overview/overview.js"></script>
        <title>CoinPay Overview</title>
    </head>
    <body>
        ...
        <div class="page">
            ...
            <div class="chart">
                <canvas width="1645" height="350" id="myChart"></canvas>
            </div>
        </div>
        <script src="http://<?=$host_name["ip_address"]?>/coinpay-admin/assets/js/overview/chart.js"></script>
    </body>
</html>
