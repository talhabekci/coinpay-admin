...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="http://localhost/coinpay-admin/assets/css/overview/overview.css">
        ...
        <script src="http://localhost/coinpay-admin/assets/js/overview/overview.js"></script>
    ...
    <body>
        ...
        <script src="http://localhost/coinpay-admin/assets/js/overview/chart.js"></script>
    </body>
</html>
