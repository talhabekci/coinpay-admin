                    ...
                    <div class="payment-tools-card">
                        <div class="card-body">
                            ...
                            <div class="card-content">
                                ...
                                <img src="http://localhost/coinpay-admin/assets/img/payment-buttons.svg" alt="Client Billing" class="content-img">
                            </div>
                        </div>
                    </div>
                    <div class="payment-tools-card">
                        <div class="card-body">
                            ...
                            <div class="card-content">
                                <div class="content-text">Simple invoicing and billing to allow your clients to pay you using cryptocurrency.</div>
                                <img src="http://localhost/coinpay-admin/assets/img/client-billing.svg" alt="Client Billing" class="content-img">
                            </div>
                        </div>
                    </div>
                    <div class="payment-tools-card">
                        <div class="card-body">
                            ...
                            <div class="card-content">
                                <div class="content-text">Simple invoicing and billing to allow your clients to pay you using cryptocurrency.</div>
                                <img src="http://localhost/coinpay-admin/assets/img/hosted-catalog.svg" alt="Client Billing" class="content-img">
                            </div>
                        </div>
                    </div>
                    <div class="payment-tools-card">
                        <div class="card-body">
                            ...
                            <div class="card-content">
                                <div class="content-text">Simple invoicing and billing to allow your clients to pay you using cryptocurrency.</div>
                                <img src="http://localhost/coinpay-admin/assets/img/pos.svg" alt="Client Billing" class="content-img">
                            </div>
                        </div>
                    </div>
                    <div class="payment-tools-card">
                        <div class="card-body">
                            ...
                            <div class="card-content">
                                <div class="content-text">Simple invoicing and billing to allow your clients to pay you using cryptocurrency.</div>
                                <img src="http://localhost/coinpay-admin/assets/img/qr-code.svg" alt="Client Billing" class="content-img">
                            </div>
                        </div>
                    </div>
                </div>
