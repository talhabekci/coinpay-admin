...
} elseif ($transaction_details["currency"] == "eth") {

    $getTransactionByHash = eth_request("eth_getTransactionByHash", [$transaction_details["txid"]], 1);
    $paid_dec = hexdec($getTransactionByHash["result"]["value"]);
    $paid = bcdiv($paid_dec, 1000000000000000000, 18);
} elseif ($transaction_details["currency"] == "usdt") {

    $getTransactionReceipt = eth_request("eth_getTransactionReceipt", [$transaction_details["txid"]], 1);
    $paid = bcdiv(hexdec($getTransactionReceipt["result"]["logs"]["0"]["data"]), "100", 8);
}
...
<head>
    ...
    <link rel="stylesheet" href="http://<?= $host_name["ip_address"] ?>/coinpay-admin/assets/css/payments/payment.css">
    ...
    <script src="http://<?= $host_name["ip_address"] ?>/coinpay-admin/assets/js/payments/payment.js"></script>
                        ...
                        <div class="details-panel">
                            <div class="details-section">
                                ...
                                <div class="details-panel-item">
                                    ...
                                    ?>
                                        <div class="details-panel-item-field green">Complated</div>
                                    <?php
                                    } else {
                                    ?>
                                        <div class="details-panel-item-field red">Cancelled</div>
                                    <?php
                                    }
                                    ?>
                                </div>
