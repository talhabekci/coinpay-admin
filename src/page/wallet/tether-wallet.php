...
$usdt_current = request_to_url("http://localhost/coinpay/src/usdtPrice/usdt-to-usd?totalPrice=1");
...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/coinpay-admin/assets/css/wallet/tether-wallet.css">
    ...
    <script src="http://localhost/coinpay-admin/assets/js/wallet/tether-wallet.js"></script>
...
<body>
    ...
    <div class="page">
        <div class="page_title">
            <img src="http://localhost/coinpay-admin/assets/img/usdt.svg" width="32" height="32" alt="Bitcoin">
